...
<div class="w-screen h-screen top-0 left-0 fixed pointer-events-none z-20">
	...
	<div transition:fly={{x:"-100%"}} class="w-full lg:w-3/5 h-full lg:h-3/5 p-8 lg:p-24 z-20 flex flex-col xl:flex-row items-start fixed top-0 lg:top-0 bg-black left-[10%] gap-16 lg:left-[20%] pointer-events-auto overflow-y-scroll">
