...
<div class="w-full flex flex-col  p-2 sm:p-8 justify-{justify} text-{float} {klass}"
     style="background-color: {backgroundColor}"
>
    {#if resolvedIcon}
        <img src={resolvedIcon} alt={iconAltText} class="w-[40px] h-[40px] mb-7 {horizontalFloatMargin}"/>
    {/if}
    {#if labelText}
