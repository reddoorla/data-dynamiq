...
<div class="max-w-[720px] w-full mx-auto cursor-pointer relative {klass}" role="separator" onmouseover={()=> selectHover=true} onfocus={()=> selectHover=true} onmouseout={()=> selectHover=false} onblur={()=> selectHover=false} >
